...
namespace RemoteApi.Integration.Helpers
{
    public class TestInstructionReceiverFactory : BaseInstructionReceiverFactory
    {
        ...
        public TestInstructionReceiverFactory(Func<AddressFamily, SocketType, ProtocolType, string, ISegmentedSocket> socketFactory, IRecorder recorder) : base(recorder)
        {
